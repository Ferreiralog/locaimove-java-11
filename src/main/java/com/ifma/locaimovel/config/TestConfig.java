...
import com.ifma.locaimovel.entiteis.Aluguel;
...
public class TestConfig implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		...
		// Cliente c4 = new Cliente(null, "Joaqim Green", "98766632465", "2002-10-12");

		clienteRepository.saveAll(Arrays.asList(c1, c2, c3));

		// Endereco en1 = new Endereco(null,"Rua das araras","123A","Angelim",
		// "67000000","São Luís","MA");
		// Endereco en2 = new Endereco(null,"Rua 4","23","Cohatrac", "67000000","Paço do
		// Lumir","MA");
		// Endereco en3 = new Endereco(null,"Av. Castelo","1023","Araçagy",
		// "67000000","Ribamar","MA");
		...
		Locacao l3 = new Locacao(null, Instant.parse("2017-07-21T03:42:10Z"), Instant.parse("2018-07-21T03:42:10Z"),
				StatusLocacao.OCUPADO, c3, "Casa de praia");

		locacaoRepository.saveAll(Arrays.asList(l1, l2, l3));

		// crinado o objto aluguel

		Aluguel al1 = new Aluguel(null, (1800.00 * 0.1) + 1800.00, 0.1, Instant.parse("2019-06-20T20:53:07Z"),
				Instant.parse("2019-07-20T20:53:07Z"), "aluguel pago", l1);
		l1.setAluguel(al1);
		locacaoRepository.save(l1);
		Aluguel al2 = new Aluguel(null, 2600.00, 0.1, Instant.parse("2020-06-20T20:53:07Z"),
				Instant.parse("2020-06-20T20:53:07Z"), "aluguel pago", l2);
		l2.setAluguel(al2);
		locacaoRepository.save(l2);
		Aluguel al3 = new Aluguel(null, 1600.00, 0.1, Instant.parse("2020-03-20T09:53:07Z"),
				Instant.parse("2020-03-18T14:53:07Z"), "aluguel pago", l3);
		l3.setAluguel(al3);
		...
		// Imoveis im4 = new Imoveis(null, 5000.00, 5, 3, 2, 100000.00,
		// ImovelTipo.FAZENDA, l1);
		// Imoveis im5 = new Imoveis(null, 500.00, null, 1, 2, 10000.00,
		// ImovelTipo.COMERCIAL, l3);

		imoveisRepository.saveAll(Arrays.asList(im1, im2, im3));
		...
		Endereco en2 = new Endereco(null, "Rua 4", "23", "Cohatrac", "67000000", "Paço do Lumir", "MA", im2);
		im2.setEndereco(en2);
		imoveisRepository.save(im2);
		Endereco en3 = new Endereco(null, "Av. Castelo", "1023", "Araçagy", "67000000", "Ribamar", "MA", im3);
		im3.setEndereco(en3);
		imoveisRepository.save(im3);
